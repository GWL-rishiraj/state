...
from blogango.views import _get_archive_months, _get_sidebar_objects
...
class BlogangoContext(template.Node):
    ...
    def render(self, context):
        ...
        tags = Tag.objects.all()#.annotate(num_tagged_entries=Count('taggit_taggeditem_items')).filter(num_tagged_entries__gt=1)
